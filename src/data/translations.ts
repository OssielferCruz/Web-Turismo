...
export const UI_TRANSLATIONS: Record<Language, Record<string, string>> = {
  es: {
    ...
    fieldEntrance: "Entrada",
    fieldDuration: "Duración",
    fieldDifficulty: "Dificultad",
    fieldSchedule: "Horario",
    fieldVisitors: "Visitantes",
    fieldTips: "Recomendación de Visita",
  ...
  en: {
    ...
    fieldEntrance: "Admission",
    fieldDuration: "Duration",
    fieldDifficulty: "Difficulty",
    fieldSchedule: "Schedule",
    fieldVisitors: "Visitors",
    fieldTips: "Visiting Tip",
